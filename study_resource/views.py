...
def ContributeFileResourceView(request, id):
	study_resource = StudyResource.objects.get(id=id)
	...
	if request.method == "POST":
		...
		context = {"study_resource": study_resource}
		return render(request, "study_resource/contribute_to_files.html", context)
...
def ChatForumView(request):
	context = {}
	return render(request, "study_resource/chat_forum.html", context)
